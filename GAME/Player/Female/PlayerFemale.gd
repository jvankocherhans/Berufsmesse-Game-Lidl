...
@onready var eyes2 = $"Armature/Skeleton3D/eyes2"
@onready var hair = $Armature/Skeleton3D/hair
@onready var skin = $Armature/Skeleton3D/skin
...
func generate_custom_look():
	...
	hair.set_surface_override_material(1, material_hair)
	hair.set_surface_override_material(2, material_hair)
